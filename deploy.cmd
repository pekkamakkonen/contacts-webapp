...
IF NOT DEFINED ANGULAR_BUILD_COMMAND (
  echo Angular build command not found. Add ANGULAR_BUILD_COMMAND key with value like 'ng build --environment=test --prod --base-href /' into Azure App settings.
